...
//       <Link
//         className="relative block overflow-hidden bg-[#dbe2df]"
...
//           {article.video && (
//             <span
//               className="absolute left-1/2 top-1/2 z-[2] grid h-[46px] w-[46px] -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-black/72 pl-[3px] text-white"
